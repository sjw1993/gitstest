//创建模块
var m = angular.module('sjw',['ui.router']);
//配置路由 用来界面切换
...
//		var name = getCookie('username').name;
		...
		$('#imgHeader').attr('src','../images/'+aCookie.img+'');
			...
			location.href='http://localhost/oAhotel/html/login.html';
		}
...
//			console.log(aCookie.id);
			$http({
				method : 'POST',
				url    : 'http://localhost/oAhotel/php/changePassword.php',
				headers: {
...
//请求员工信息			
		$scope.user='';
			$http({
					url:'http://localhost/oAhotel/php/login.php',
			 		method:'POST',
			 		headers:{
			 			'content-type':'application/x-www-form-urlencoded'
			 		},
...
//				console.log($index);
				$http({
					url:'http://localhost/oAhotel/php/deleteAccount.php',
			 		method:'POST',
			 		headers:{
			 			'content-type':'application/x-www-form-urlencoded'
			 		},
...
//				console.log($scope.fileimg);
				$http({
					url:'http://localhost/oAhotel/php/addAccount.php',
			 		method:'POST',
			 		headers:{
			 			'content-type':'application/x-www-form-urlencoded'
			 		},
...
//更新数据的请求
				$http({
					url:'http://localhost/oAhotel/php/updateAccount.php',
			 		method:'POST',
			 		headers:{
			 			'content-type':'application/x-www-form-urlencoded'
			 		},
				...
				location.reload('http://localhost/oAhotel/html/index.html#/searchAccount');
				});
...
//			console.log($scope.chkBtn);
			$http({
				method : 'POST',
				url : 'http://localhost/oAhotel/php/addSysDo.php',
				headers : {
					'content-type' : 'application/x-www-form-urlencoded'
				},
				data : $.param({
...
//这是关键字搜索$scope.roomKey
		...
		$http({
			method : 'GET',
			url    : 'http://localhost/oAhotel/php/searchRoom.php',
			cache  : true,
		}).then(function(res){
//查询客房信息数据
...
//删除请求
			$http({
				method : 'POST',
				url    : 'http://localhost/oAhotel/php/delroom.php',
				headers : {
					'content-type' : 'application/x-www-form-urlencoded'
				},
				data  :$.param({
				...
				location.reload('http://localhost/oAhotel/html/index.html#/searchRoom')
			})
...
//点击确认修改后发送http请求后台 修改数据库数据
		$scope.roomBtn = function(){
			$http({
				method : 'POST',
				url    : 'http://localhost/oAhotel/php/updateRoom.php',
				headers: {
					'content-type' : 'application/x-www-form-urlencoded'
				},
				data : $.param({
...
//这是查询客户信息的controller
	m.controller('ctrl4',['$scope','$http','$filter',function($scope,$http,$filter){
		...
		$http({
			method : 'GET',
			url    : 'http://localhost/oAhotel/php/searchCustomer.php',
			cache  :true,
...
//删除客户信息
		$scope.deleteCustomer = function(id,index){
			$http({
				method : 'POST',
				url    : 'http://localhost/oAhotel/php/deleteCustomer.php',
				headers: {
					'content-type':'application/x-www-form-urlencoded'
				},
				data   :$.param({
				...
				location.reload('http://localhost/oAhotel/html/index.html#/searchCustomer');
			});
...
//			console.log($scope.cuname);
			$http({
				method : 'POST',
				url    : 'http://localhost/oAhotel/php/updateCustomer.php',
				headers: {
					'content-type' : 'application/x-www-form-urlencoded'
				},
				data   : $.param({
...
//发送添加数据请求 写入数据库
			$http({
			method : 'POST',
			url    : 'http://localhost/oAhotel/php/addRoom.php',
			headers:{
				'content-type' : 'application/x-www-form-urlencoded'
			},
			data : $.param({
...
//这是添加客户信息的控制器
	m.controller('ctrl6',['$scope','$http','$filter',function($scope,$http,$filter){
		...
		$scope.addCutomer = function(){
			...
			$http({
				method : 'POST',
				url    : 'http://localhost/oAhotel/php/addCustomer.php',
				headers: {
					'content-type' : 'application/x-www-form-urlencoded'
				},
				data   : $.param({
...
//这是添加订单的控制器
	m.controller('ctrl7',['$scope','$http',function($scope,$http){
		...
		$scope.addOrder = function(){
			$http({
			method : 'POST',
			url    : 'http://localhost/oAhotel/php/addOrder.php',
			headers: {
				'content-type' : 'application/x-www-form-urlencoded'
			},
			data : $.param({
			...
			location.reload('http://localhost/oAhotel/html/index.html#/searchOrder');
		});
		}	 
...
//这是查询，删除，修改订单的控制器
	m.controller('ctrl8',['$scope','$http','$filter',function($scope,$http,$filter){
		...
		$http({
			method : 'POST',
			url    : 'http://localhost/oAhotel/php/searchOrder.php',
			headers: {
				'content-type' : 'application/x-www-form-urlencoded'
			},
			cache :true
...
//			console.log(id);
			...
			$http({
				method : 'POST',
				url    : 'http://localhost/oAhotel/php/deleteOrder.php',
				headers: {
					'content-type' : 'application/x-www-form-urlencoded'
				},
				data   : $.param({
...
//		console.log($('.orinTime').val());
			$http({
				method : 'POST',
				url    : 'http://localhost/oAhotel/php/updateOrder.php',
				headers: {
					'content-type' : 'application/x-www-form-urlencoded'
				},
				data   : $.param({
...
//将订单添加到入住信息中，客户当天入住
		...
		$scope.orderTolive = function(){
			$http({
				method : 'POST',
				url    : 'http://localhost/oAhotel/php/addLiveIn.php',
				headers: {
					'content-type' : 'application/x-www-form-urlencoded'
				},
				data   :$.param({	
...
//				location.reload('http://localhost/oAhotel/html/index.html#/searchLivein');
			})
		}
...
//发送查询请求
		$http({
			method : 'POST',
			url    : 'http://localhost/oAhotel/php/searchLiveIn.php',
			cache  : true
		}).then(function(res){
...
//到期退房事件
	$scope.chkOut = function(id){
		...
		$http({
			method : 'POST',
			url    : 'http://localhost/oAhotel/php/deleteLiveIn.php',
			headers: {
				'content-type' : 'application/x-www-form-urlencoded'
			},
			data   : $.param({
...
//修改入住信息操作
	...
	$scope.liveOk = function(){
		...
		$http({
			method : 'POST',
			url    : 'http://localhost/oAhotel/php/updateLiveIn.php',
			headers: {
				'content-type' : 'application/x-www-form-urlencoded'
			},
			data   : $.param({
